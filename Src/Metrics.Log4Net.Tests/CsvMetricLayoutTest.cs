...
namespace Metrics.Log4Net.Tests
{
    public class CsvMetricLayoutTest
    {
        ...
        public void HeaderContainsAllColumnsSplittableByDelimiter(Type value)
        {
            ...
            var header = sut.Header.Split(new[] { CsvDelimiter.Delimiter, Environment.NewLine }, StringSplitOptions.RemoveEmptyEntries);
        ...
        public void TheOutputWillContainOneDelimiterPerColumn(Type value)
        {
            ...
            using (var writer = new StreamWriter(stream))
            {
                ...
                var numberOfDelimitersInOutput = actual.Split(new[] { CsvDelimiter.Delimiter }, StringSplitOptions.None).Length - 1;
